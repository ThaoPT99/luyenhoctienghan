...
const lessonsData = [
    ...
    },
    {
        ...
        reading: '드디어 마지막 수업이에요! 45개의 모든 수업을 듣느라 정말 수고 많았어요. 처음에는 한글도 몰랐지만 지금은 한국어로 말하고, 읽고, 쓸 수 있게 됐어요. 정말 대단한 일이에요! 한국어 공부는 여기서 끝나는 게 아니에요. 이제부터가 진짜 시작이에요. 한국 드라마를 볼 때, K-pop을 들을 때, 한국 친구와 대화할 때마다 실력이 늘 거예요. 

TOPIK 2 시험을 준비하고 있다면 자신감을 가져요. 여러분은 이미 많은 것을 배웠어요. 천천히, 하지만 꾸준히 공부하면 꼭 합격할 수 있어요. 

여러분의 한국어 공부를 항상 응원할게요! 화이팅! 🎉🔥',
        readingQuestions: [
